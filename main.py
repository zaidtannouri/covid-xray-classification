...
train_losses_dual, val_losses_dual, train_accs_dual, val_accs_dual = trainer_dual.train()
...
true_labels_single, predictions_single = evaluate_model(single_image_model, val_data, trainer_single.criterion, device)
print("\nEvaluating dual image model...")
true_labels_dual, predictions_dual = evaluate_model(dual_image_model, val_data_dual, trainer_dual.criterion, device)

# Decode the true labels and predictions
class_names = list(train_data.df['Labels'].unique())  # Class names
